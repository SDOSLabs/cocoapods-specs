Pod::Spec.new do |spec|
  ...
  spec.source       = { :svn => "http://svn.sdos.es/Sdos/ComponentesIOS/Librerias/Extensions", :tag => "1.2.2" }
  ...
  spec.framework    = ['Foundation', 'UIKit', 'MapKit', 'Accelerate', 'QuartzCore', 'MessageUI', 'MobileCoreServices']
  spec.libraries    = 'z'
